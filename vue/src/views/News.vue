<template>
    <div style="padding: 10px">
        ...
        <div style="margin: 10px 0">
            <el-button type="primary" @click="add" icon="el-icon-circle-plus-outline" v-if="name==='admin'">新增</el-button>
        </div>
        ...
        <el-table
            ...
            <el-table-column label="操作">
                <template #default="scope">
                    ...
                    <el-button size="mini" @click="handleEdit(scope.row)" v-if="name==='admin'">编辑</el-button>
                    <el-button size="mini" type="danger" @click="handleDelete(scope.row.id)" v-if="name==='admin'">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
