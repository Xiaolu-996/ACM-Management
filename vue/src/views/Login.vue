        ...
        <div class="video-container">
            <div :style="fixStyle" class="filter">
                <div style="width: 400px; margin: 100px auto">
                    <div style="font-size: 30px; text-align: center; padding: 30px 0; color: #333">ACM训练管理系统</div>
                    <el-form ref="form" :model="form" size="normal" :rules="rules">
                        ...
                        <el-form-item>
                            <div style="display: flex">
                                <el-input prefix-icon="el-icon-key" @keydown.enter.native="login" v-model="form.validCode" style="width: 50%;" placeholder="请输入验证码"></el-input>
